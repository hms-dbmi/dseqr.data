...
drugs <- fread('data-raw/drug_annot/repurposing_drugs_20200324.txt', skip = 'pert_iname')
samples <- fread('data-raw/drug_annot/repurposing_samples_20200324.txt', skip = 'pert_iname')
...
lincs2_drugs_annot <- setup_annot(annot, 'lincs2_drugs')
lincs2_genes_annot <- setup_genes_annot('lincs2')
